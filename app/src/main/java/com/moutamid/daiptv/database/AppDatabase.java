...
@Database(entities = {ChannelsModel.class, ChannelsGroupModel.class, SeriesGroupModel.class, MoviesGroupModel.class, RecentChannelsModel.class}, version = 1, exportSchema = false)
